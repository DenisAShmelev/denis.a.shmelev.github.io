...
template _tmp_0
{
    ...
    row _tmp_208
    {
        ...
        valuefield _tmp_313
        {
            name = "ValueField_13";
            location = (109, 1);
            formula = "round(GetValue(\"LENGTH\"), 1)";
            maxnumoflines = 1;
            datatype = INTEGER;
            class = "";
            cacheable = TRUE;
    ...
    row _tmp_1
    {
        ...
        visibility = TRUE;
        usecolumns = FALSE;
        rule = "if (mid(GetValue(\"ASSEMBLY_POS\"), \"0\", \"2\") == \"HQ\") then\n  Output()\nelse\n  StepOver()\nendif";
        ...
        valuefield _tmp_35
        {
            name = "ValueField_25";
            location = (135, 2);
            formula = "GetValue(\"PART_MATERIAL\")";
            maxnumoflines = 1;
            datatype = STRING;
            class = "";
            cacheable = TRUE;
        ...
        valuefield _tmp_3
        {
            name = "ValueField_30";
            location = (145, 2);
            formula = "GetValue(\"ASSEMBLY.PART.MATERIAL\")";
            maxnumoflines = 1;
            datatype = STRING;
            class = "";
            cacheable = TRUE;
        ...
        valuefield _tmp_5
        {
            name = "ValueField_31";
            location = (135, 0);
            formula = "GetValue(\"PART.MATERIAL\")";
            maxnumoflines = 1;
            datatype = STRING;
            class = "";
            cacheable = TRUE;
        ...
        valuefield _tmp_7
        {
            name = "ValueField_32";
            location = (145, 0);
            formula = "GetValue(\"ASSEMBLY.PART_MATERIAL\")";
            maxnumoflines = 1;
            datatype = STRING;
            class = "";
            cacheable = TRUE;
