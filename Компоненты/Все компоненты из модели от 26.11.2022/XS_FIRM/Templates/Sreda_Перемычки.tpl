    ...
    row _tmp_856
    {
        ...
        row _tmp_168
        {
            ...
            row _tmp_126
            {
                ...
                visibility = TRUE;
                usecolumns = FALSE;
                rule = "if (GetValue(\"ASSEMBLY.ASSEMBLY_PREFIX\")== \"ПР\" || GetValue(\"ASSEMBLY.ASSEMBLY_NAME\")== \"ПЕРЕМЫЧКА\" || GetValue(\"ASSEMBLY.ASSEMBLY_NAME\")== \"Перемычка\" || GetValue(\"ASSEMBLY_PREFIX\")== \"ПР\" || GetValue(\"ASSEMBLY_NAME\")== \"ПЕРЕМЫЧКА\" || GetValue(\"ASSEMBLY_NAME\")== \"Перемычка\" || GetValue(\"PHASE\")==\"111\") then\n  Output()\nelse\n  StepOver()\nendif";
                contenttype = "CAST_UNIT";
                sorttype = COMBINE;
